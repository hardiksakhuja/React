...
class Contact extends Component {
    ...
    constructor(props) {
        ...
        this.hnadleBlur = this.hnadleBlur.bind(this);
    }
                            ...
                            <FormGroup row>
                                ...
                                <Col md={10}>
                                    <Input type="text" id="firstname" name="firstname" 
                                        ...
                                        onBlur={this.hnadleBlur('firstname')} 
                            ...
                            <FormGroup row>
                                ...
                                <Col md={10}>
                                    <Input type="text" id="lastname" name="lastname" 
                                        ...
                                        onBlur={this.hnadleBlur('lastname')}
                                        onChange={this.handleInputChange} />
